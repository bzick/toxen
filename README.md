...
- Проблема если класс расширяет другой класс не входящий в состав PHP, PHP расширений или проекта. Создать его нет возможности так как нет родительского класса. Как-то динамически это надо делать. Решение: Создавать будет динамический загрузчик, на момент выполнения запроса.
